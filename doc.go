...
//
// Since ZeroMQ sockets are not thread-safe, they they cannot be used directly
// for sending and receiving in different goroutines (e.g. when using a socket
// type with unrestricted send/receive pattern).  This package interleaves the
